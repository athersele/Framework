...
public class ForgotPasswordPage {
	...
	@FindBy(xpath = "//*[contains(text(),'Connect with friends and the world around you on Facebook.')]") WebElement ConnecttoFacebook;
	...
	public String ConnectText() {
		String Connect=ConnecttoFacebook.getText();
		return Connect;
